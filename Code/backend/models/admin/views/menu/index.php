...
<div class="layui-tab-item layui-show">
    ...
    <table class="layui-table">
        ...
        <?php foreach($menu as $vo):?>
            ...
            <?php if(!empty($vo['_child'])):?>
                <?php foreach($vo['_child'] as $v):?>
                    <tr>
                        <td><?=$v['menu_name']?></td>
                        <td><input type="number" name="sort" class="layui-input" value="<?=$v['sort'] ?>" /></td>
                        <td>
        ...
        <tr>
            <td colspan="3" style="text-align: center"><a class="layui-btn layui-btn-mini" lay-event="update">更新</a></td>
        </tr>
    </table>
</div>
